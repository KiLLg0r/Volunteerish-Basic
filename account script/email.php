...
?>
    ...
    <body>
        ...
        <div class="change">
            ...
            <p>You can change or can edit your email</p>
            ...
            <form action="./acc.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
                <label for="">Enter your old email</label>
                <div class="input">
                    <img src="https://s2.svgbox.net/hero-solid.svg?ic=mail&color=ff0000" width="40" height="40" />
                    <input type="email" name="oemail" placeholder="Enter your email..." />
                </div>

                <label for="">Enter your new email</label>
                <div class="input">
                    <img src="https://s2.svgbox.net/hero-solid.svg?ic=mail&color=ff0000" width="40" height="40" />
                    <input type="email" name="nemail" placeholder="Enter your new email..." />
                </div>
